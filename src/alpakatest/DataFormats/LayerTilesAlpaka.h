...
using GPUVect = cms::alpakatools::VecArray<int, LayerTilesConstants::maxTileDepth>;
...
public:
  ...
  ALPAKA_FN_ACC
  void fill(float x, float y, int i) { layerTiles_[getGlobalBin(x, y)].push_back(acc_, i); }
  ...
  ALPAKA_FN_HOST_ACC GPUVect& operator[](int globalBinId) { return layerTiles_[globalBinId]; }

private:
  cms::alpakatools::VecArray<cms::alpakatools::VecArray<int, LayerTilesConstants::maxTileDepth>,
