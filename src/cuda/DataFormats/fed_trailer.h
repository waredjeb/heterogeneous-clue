...
#define FED_CRC_MODIFIED_EXTRACT(a) \
  (((a) >> FED_CRC_MODIFIED_SHIFT) & FED_CRC_MODIFIED_WIDTH)
...
#define FED_SLINK_ERROR_EXTRACT(a) \
  (((a) >> FED_SLINK_ERROR_SHIFT) & FED_SLINK_ERROR_WIDTH)
...
#define FED_WRONG_FEDID_EXTRACT(a) \
  (((a) >> FED_WRONG_FEDID_SHIFT) & FED_WRONG_FEDID_WIDTH)
